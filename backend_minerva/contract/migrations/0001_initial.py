# Generated by Django 5.2 on 2025-05-12 00:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('ATIVO', 'ATIVO'), ('ENCERRADO', 'ENCERRADO')], default='ATIVO', max_length=30, verbose_name='Status')),
                ...
                ('main_inspector', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='contracts_main_inspector', to='employee.employee', verbose_name='Fiscal Principal')),
                ('substitute_inspector', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='contracts_substitute_inspector', to='employee.employee', verbose_name='Fiscal Substituto')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('description', models.CharField(max_length=255, verbose_name='Descrição')),
                ('type', models.CharField(choices=[('Acréscimo de Valor', 'Acréscimo de Valor'), ('Redução de Valor', 'Redução de Valor'), ('Prorrogação de Prazo', 'Prorrogação de Prazo')], max_length=20, verbose_name='Tipo')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Criado em')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Atualizado em')),
                ('contract', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Contrato', to='contract.contract')),
